...
router.post("/users/login", UserRoute_1.user.login);
router.post("/users/refresh-token", UserRoute_1.user.refreshToken);
router.get("/users", [ensureAuthenticated_1.ensureAuthenticated, authorizationVerifier_1.authorizationVerifier], UserRoute_1.user.getAll);
router.get("/users/:id", [ensureAuthenticated_1.ensureAuthenticated, authorizationVerifier_1.authorizationVerifier], UserRoute_1.user.get);
router.delete("/users/:id", [ensureAuthenticated_1.ensureAuthenticated, authorizationVerifier_1.authorizationVerifier], UserRoute_1.user.delete);
router.put("/users/:id", [ensureAuthenticated_1.ensureAuthenticated, authorizationVerifier_1.authorizationVerifier], UserRoute_1.user.update);
